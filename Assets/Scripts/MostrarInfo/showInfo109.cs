...
public class showInfo109 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "MEITNERIO \r\n\r\n" +
                    "Símbolo: Mt \r\n" +
                    "Número Atómico: 109 \r\n" +
                    "Peso Atómico: (278)", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("109_Meitnerio");
            }
