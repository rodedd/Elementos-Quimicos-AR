...
public class showInfo66 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "DISPROSIO \r\n\r\n" +
                    "Símbolo: Dy \r\n" +
                    "Número Atómico: 66 \r\n" +
                    "Peso Atómico: 162.50", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("66_Disprosio");
            }
