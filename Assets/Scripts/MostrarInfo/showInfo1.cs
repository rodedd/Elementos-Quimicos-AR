...
public class showInfo1 : MonoBehaviour, ITrackableEventHandler
{
    ...
    private Rect Salir = new Rect(890, 700, 110, 45);
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "HIDRÓGENO \r\n\r\n" +
                    "Símbolo: H\r\n" +
                    "Número Atómico: 1 \r\n" +
                    "Peso Atómico: 1.008", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("01_Hidrogeno");
            }
