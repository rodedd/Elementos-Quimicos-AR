...
public class showInfo40 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "ZIRCONIO \r\n\r\n" +
                    "Símbolo: Zr \r\n" +
                    "Número Atómico: 40 \r\n" +
                    "Peso Atómico: 91.224", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("40_Zirconio");
            }
