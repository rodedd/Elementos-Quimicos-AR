...
public class showInfo98 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "CALIFORNIO \r\n\r\n" +
                    "Símbolo: Cf \r\n" +
                    "Número Atómico: 98 \r\n" +
                    "Peso Atómico: (251)", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("98_Californio");
            }
