...
public class showInfo33 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "ARSÉNICO \r\n\r\n" +
                    "Símbolo: As \r\n" +
                    "Número Atómico: 33 \r\n" +
                    "Peso Atómico: 74.922", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("33_Arsenico");
            }
