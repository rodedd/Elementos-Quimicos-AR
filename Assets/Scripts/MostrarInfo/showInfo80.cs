...
public class showInfo80 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "MERCURIO \r\n\r\n" +
                    "Símbolo: Hg \r\n" +
                    "Número Atómico: 80 \r\n" +
                    "Peso Atómico: 200.59", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("80_Mercurio");
            }
