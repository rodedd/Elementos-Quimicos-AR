...
public class showInfo74 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "WOLFRAMIO \r\n\r\n" +
                    "Símbolo: W \r\n" +
                    "Número Atómico: 74 \r\n" +
                    "Peso Atómico: 183.84", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("74_Wolframio");
            }
