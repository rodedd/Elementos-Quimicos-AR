...
public class showInfo32 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "GERMANIO \r\n\r\n" +
                    "Símbolo: Ge \r\n" +
                    "Número Atómico: 32 \r\n" +
                    "Peso Atómico: 72.630", MiEstilo);

            GUI.backgroundColor = Color.black;
            GUI.Box(InfoElectrones, "Configuración \r\nElectrónica: \r\n" +
                "[Ar] 3d\u00b9\u2070 4s\u00b2 4p\u00b2", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("32_Germanio");
            }
