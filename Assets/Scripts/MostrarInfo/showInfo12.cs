...
public class showInfo12 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "MAGNESIO \r\n\r\n" +
                    "Símbolo: Mg \r\n" +
                    "Número Atómico: 12 \r\n" +
                    "Peso Atómico: 24.305", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("12_Magnesio");
            }
