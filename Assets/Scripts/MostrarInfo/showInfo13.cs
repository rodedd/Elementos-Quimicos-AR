...
public class showInfo13 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "ALUMINIO \r\n\r\n" +
                    "Símbolo: Al \r\n" +
                    "Número Atómico: 13 \r\n" +
                    "Peso Atómico: 26.982", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("13_Aluminio");
            }
