...
public class showInfo38 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "ESTRONCIO \r\n\r\n" +
                    "Símbolo: Sr \r\n" +
                    "Número Atómico: 38 \r\n" +
                    "Peso Atómico: 87.62", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("38_Estroncio");
            }
