...
public class showInfo118 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "OGANESÓN \r\n\r\n" +
                    "Símbolo: Og \r\n" +
                    "Número Atómico: 118 \r\n" +
                    "Peso Atómico: (294)", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("118_Oganeson");
            }
