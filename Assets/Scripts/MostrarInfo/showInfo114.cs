...
public class showInfo114 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "FLEROVIO \r\n\r\n" +
                    "Símbolo: Fl \r\n" +
                    "Número Atómico: 114 \r\n" +
                    "Peso Atómico: (289)", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("114_Flerovio");
            }
