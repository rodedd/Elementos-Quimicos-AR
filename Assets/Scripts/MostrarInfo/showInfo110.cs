...
public class showInfo110 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "DARMSTATIO \r\n\r\n" +
                    "Símbolo: Ds \r\n" +
                    "Número Atómico: 110 \r\n" +
                    "Peso Atómico: (281)", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("110_Darmstadio");
            }
