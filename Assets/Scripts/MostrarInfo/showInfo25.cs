...
public class showInfo25 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "MANGANESO \r\n\r\n" +
                    "Símbolo: Mn \r\n" +
                    "Número Atómico: 25 \r\n" +
                    "Peso Atómico: 54.938", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("25_Manganeso");
            }
