...
public class showInfo19 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "POTASIO \r\n\r\n" +
                    "Símbolo: K \r\n" +
                    "Número Atómico: 19 \r\n" +
                    "Peso Atómico: 39.098", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("19_Potasio");
            }
