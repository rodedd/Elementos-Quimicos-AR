...
public class showInfo42 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "MOLIBDENO \r\n\r\n" +
                    "Símbolo: Mo \r\n" +
                    "Número Atómico: 42 \r\n" +
                    "Peso Atómico: 95.95", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("42_Molibdeno");
            }
