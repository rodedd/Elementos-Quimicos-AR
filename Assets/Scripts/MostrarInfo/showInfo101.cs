...
public class showInfo101 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "MENDELEVIO \r\n\r\n" +
                    "Símbolo: Md \r\n" +
                    "Número Atómico: 101 \r\n" +
                    "Peso Atómico: (258)", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("101_Mendelevio");
            }
