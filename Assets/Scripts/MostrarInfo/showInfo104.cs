...
public class showInfo104 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "RUTHERFORDIO \r\n\r\n" +
                    "Símbolo: Rf \r\n" +
                    "Número Atómico: 104 \r\n" +
                    "Peso Atómico: (267)", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("104_Rutherfordio");
            }
