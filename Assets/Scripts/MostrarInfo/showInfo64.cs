...
public class showInfo64 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "GADOLINIO \r\n\r\n" +
                    "Símbolo: Gd \r\n" +
                    "Número Atómico: 64 \r\n" +
                    "Peso Atómico: 157.25", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("64_Gadolinio");
            }
