...
public class showInfo21 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "ESCANDIO \r\n\r\n" +
                    "Símbolo: Sc \r\n" +
                    "Número Atómico: 21 \r\n" +
                    "Peso Atómico: 44.956", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("21_Escandio");
            }
