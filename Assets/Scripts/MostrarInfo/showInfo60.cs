...
public class showInfo60 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "NEODIMIO \r\n\r\n" +
                    "Símbolo: Nd \r\n" +
                    "Número Atómico: 60 \r\n" +
                    "Peso Atómico: 144.24", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("60_Neodimio");
            }
