...
public class showInfo59 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "PRASEODIMIO \r\n\r\n" +
                    "Símbolo: Pr \r\n" +
                    "Número Atómico: 59 \r\n" +
                    "Peso Atómico: 140.91", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("59_Praseodimio");
            }
