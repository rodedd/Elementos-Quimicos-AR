...
public class showInfo115 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "MOSCOVIO \r\n\r\n" +
                    "Símbolo: Mc \r\n" +
                    "Número Atómico: 115 \r\n" +
                    "Peso Atómico: (290)", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("115_Moscovio");
            }
