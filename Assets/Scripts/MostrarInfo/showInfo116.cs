...
public class showInfo116 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "LIVERMORIO \r\n\r\n" +
                    "Símbolo: Lv \r\n" +
                    "Número Atómico: 116 \r\n" +
                    "Peso Atómico: (293)", MiEstilo);

            GUI.backgroundColor = Color.black;
            GUI.Box(InfoElectrones, "Configuración \r\nElectrónica: \r\n" +
                "[Rn] 5f\u00b9\u2074 6d\u00b9\u2070 7s\u00b2 7p\u2074", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("116_Livermorio");
            }
