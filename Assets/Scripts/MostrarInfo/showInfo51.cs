...
public class showInfo51 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "ANTIMONIO \r\n\r\n" +
                    "Símbolo: Sb \r\n" +
                    "Número Atómico: 51 \r\n" +
                    "Peso Atómico: 121.76", MiEstilo);

            GUI.backgroundColor = Color.black;
            GUI.Box(InfoElectrones, "Configuración \r\nElectrónica: \r\n" +
                "[Kr] 4d\u00b9\u2070 5s\u00b2 5p\u00b3", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("51_Antimonio");
            }
