...
public class showInfo103 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "LAURENCIO \r\n\r\n" +
                    "Símbolo: Lr \r\n" +
                    "Número Atómico: 103 \r\n" +
                    "Peso Atómico: (266)", MiEstilo);

            GUI.backgroundColor = Color.black;
            GUI.Box(InfoElectrones, "Configuración \r\nElectrónica: \r\n" +
                "[Rn] 5f\u00b9\u2074 7s\u00b2 7p\u00b9", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("103_Lawrencio");
            }
