...
public class showInfo7 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "NITRÓGENO \r\n\r\n" +
                    "Símbolo: N \r\n" +
                    "Número Atómico: 7 \r\n" +
                    "Peso Atómico: 14.007", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("07_Nitrogeno");
            }
