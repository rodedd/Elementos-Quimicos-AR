...
public class showInfo111 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "ROENTGENIO \r\n\r\n" +
                    "Símbolo: Rg \r\n" +
                    "Número Atómico: 111 \r\n" +
                    "Peso Atómico: (282)", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("111_Roentgenio");
            }
