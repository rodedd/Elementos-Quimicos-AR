...
public class showInfo106 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "SEABORGIO \r\n\r\n" +
                    "Símbolo: Sg \r\n" +
                    "Número Atómico: 106 \r\n" +
                    "Peso Atómico: (269)", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("106_Seaborgio");
            }
