...
public class showInfo99 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "EINSTENIO \r\n\r\n" +
                    "Símbolo: Es \r\n" +
                    "Número Atómico: 99 \r\n" +
                    "Peso Atómico: (252)", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("99_Einstenio");
            }
