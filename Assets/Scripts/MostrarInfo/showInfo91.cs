...
public class showInfo91 : MonoBehaviour, ITrackableEventHandler
{
    ...
    void OnGUI()
    {
        ...
        if (mShowInfo)
        {
            ...
            GUI.Box(InfoElemento, "PROTACTINIO \r\n\r\n" +
                    "Símbolo: Pa \r\n" +
                    "Número Atómico: 91 \r\n" +
                    "Peso Atómico: 231.04", MiEstilo);
            ...
            {
                // do something on button click 
                SceneManager.LoadScene("91_Protactinio");
            }
